...
export default function ButterflyPark() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      {/* Hero Banner */}
      <div className="relative h-[50vh] bg-blue-800 flex items-center">
        ...
        <div className="container mx-auto px-6 z-10 text-right">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mr-auto">פרויקט המגורים היוקרתי החדש שלנו המשלב חדשנות, טכנולוגיה ואיכות חיים</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-right">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                פארק הפרפרים הוא פרויקט מגורים יוקרתי הממוקם בלב אזור מתפתח עם נגישות מעולה למרכזי תחבורה, מסחר ופנאי. 
                הפרויקט תוכנן בקפידה כדי להציע חווית מגורים ברמה גבוהה המשלבת טכנולוגיות חדשניות עם עיצוב מודרני ותשומת לב לפרטים.
              </p>
              <p className="text-gray-700 mb-8 leading-relaxed">
                הדירות בפרויקט מציעות מפרט טכני עשיר, מרפסות מרווחות ונוף מרהיב. חללי המגורים תוכננו בצורה חכמה כדי לנצל את 
                המרחב בצורה אופטימלית ולאפשר איכות חיים גבוהה.
              </p>
              <div className="flex space-x-4 justify-end">
                <Link 
                  href="/butterfly-park/survey" 
                  className="bg-blue-700 text-white px-6 py-3 rounded-md font-medium transition-all hover:bg-blue-800"
                >
                  סקר התעניינות
                </Link>
                <button className="border border-blue-700 text-blue-700 px-6 py-3 rounded-md font-medium transition-all hover:bg-blue-50">
                  צפה במפרט
                </button>
              </div>
            </div>
