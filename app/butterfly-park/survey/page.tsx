                    ...
                    <div>
                      <div className="flex rounded-lg overflow-hidden shadow-sm" style={{ width: "140px" }}>
                        <button
                          ...
                          className={`flex-1 py-2 px-2 text-center cursor-pointer transition-all duration-300 text-sm ${
                            formData.profile[input.key] === 'זכר' 
                        ...
                        <button
                          ...
                          className={`flex-1 py-2 px-2 text-center cursor-pointer transition-all duration-300 text-sm ${
                            formData.profile[input.key] === 'נקבה' 
